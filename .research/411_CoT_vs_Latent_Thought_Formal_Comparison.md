...
| Complexity-class-gated routing fusion | §2.6 + §3 below (this note) | ✅ Captured — P3 track-only; requires a complexity-class classifier not provided by the paper. Issue 134 removed per noise-reduction rule after re-verification (2026-08-05); substance lives in §2.6 below. |
| FPRAS routing criterion for BoM/QuasiMoTTo | §2.6 + §3 below (this note) | ✅ Captured — the FPRAS arm is the #P-detection half of the classifier blocker. Formerly Issue 135 (consolidated into Issue 134 2026-07-25); both removed after re-verification. |
...
- [x] **T7:** File `.issues/` entry for the complexity-class-gated routing fusion (SwiR × Breakeven × k_selector × DEC × BoM). DONE — filed as `.issues/134_*` (P3 track-only; blocked on a complexity-class classifier). Issue 134 removed 2026-08-06 per noise-reduction rule after re-verification (deferral blocker still missing); substance preserved in §2.6 below.
- [x] **T8:** File `.issues/` entry for the FPRAS routing criterion. DONE 2026-07-12 as `.issues/135_*`, consolidated into Issue 134 on 2026-07-25. Both removed 2026-08-06 after re-verification; substance preserved in §2.6 below.
