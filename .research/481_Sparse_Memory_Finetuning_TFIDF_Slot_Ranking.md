...
| **IDF-aware write-target selection** | ❌ **the gap — Issue 650** |
...
- **Issues:** [katgpt-rs `.issues/650`](../.issues/650_pkm_episodic_idf_write_gate.md) — the P0 implementation + GOAT gate.
