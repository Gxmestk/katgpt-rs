...
> **PASS-Redirects (synthesis):** Ueyama [arXiv:2608.23228 "mold: A Massively Parallel Linker"] — batch-pipeline parallelism cousin: mold's cumulative data-parallelism-across-all-passes ablation confirms this note's schedule-then-execute batch discipline, but linker techniques transfer nothing new (concurrent hashmap already ships as papaya; rayon thresholds already codified in rust-optimize; no latent/game-context analog). PASS.
