...
| Counterfactual Utility | `MultiDomainMemory` with `AggregationStrategy::BanditWeighted` | `crates/katgpt-core/src/delta_mem/multi.rs` |
| Cross-domain Transfer | `MultiDomainMemory` per-domain instances | `crates/katgpt-core/src/delta_mem/multi.rs` |
