...
| Frozen artifact, BLAKE3 commitment | **`NeuronShard` / `MerkleFrozenEnvelope`** | riir-neuron-db/src/shard/mod.rs, freeze.rs | MFA artifact `{μ_k, W_k, Ψ, π}` is a new shard subtype candidate. |
