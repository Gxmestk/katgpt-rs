...
2. ✅ **`.issues/585_mop_defend_wrong_poc.md`** in katgpt-rs — RUN + discharged (Bench 677, 3/4 PASS); closed + removed 2026-08-15 once outputs 3-5 below shipped (record preserved here §3.3 + Bench 677; the G4 axis follow-up — Issue 653 — also closed + removed the same day after its isolation experiment resolved the miss as an arena tie-break artifact).
