...
2. ✅ **`.issues/585_mop_defend_wrong_poc.md`** in katgpt-rs — RUN + discharged (Bench 677, 3/4 PASS); closed + removed 2026-08-15 once outputs 3-5 below shipped (record preserved here §3.3 + Bench 677 + [Issue 653](../.issues/653_mop_g4_bidirectionality_followup.md) for the G4 axis).
