...
- [x] **WASM compute shader** example tested and documented — `riir-wasm/tests/compute_shader.rs` (9 tests: GEMV, softmax, pipeline), `riir-ai/crates/riir-examples/examples/wasm_compute_shader.rs`, WAT-based GEMV+softmax compute shader via `wasmi`
