...
> **PASS-Redirects (synthesis):** Rodrigues & Kang [alphaxiv 2609.dissecting-hierarchical-reasoning-models "Dissecting Hierarchical Reasoning Models: A Mechanistic Study"] (ICML 2026 Mech Interp WS) — **GAIN** (Research 529 + katgpt-rs issue 720 + riir-ai issue 858): the *positive* complement to this note's IFT line — windowed ABSOLUTE update-magnitude cadence separates solved (‖Δz‖→0.30) from failed (plateau 1.46, 4.9×) on a real solver, supplying the degradation detector Issue 717's damping knob lacks; plus decodable≠causal (probe/SAE ablations ≈ random controls) as the audit discipline for any latent-claim surface.
