...
| **TruncatePadProjector** (`crates/katgpt-core/src/qgf/projector.rs`) | **Shared pattern** — Same truncate/pad strategy for dimension mismatch. MTP applies it to target hidden state instead of embeddings. Could share a utility function. |
