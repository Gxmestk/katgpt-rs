...
| **DEC operators** (`katgpt-dec/src/`) | A "head" is a DEC operator application (d / δ / Δ / hodge_decompose). These are *already* deterministic programs — the paper's framework is trivially satisfied. Not interesting. | n/a |
