...
> **Related (riir-clippy):** Issue 049 (the ONE Gain-tier actionable — the KAT/CF-arm growing-input conditioning POC distilled from this paper), Proposal 005 (KAT heal service network), Issue 040 (fixer re-gate — arm-B pre-pass result corroborated below), Issue 030 (relevance gate — unchanged by this verdict)
