...
//! Random, Greedy, Validator, HL, GZero, Rubric
//!
...
const ALL_PLAYERS: &[&str] = &["Random", "Greedy", "Validator", "HL", "GZero", "Rubric"];
...
const MATCHUPS: &[MatchupSpec] = &[
    ...
    MatchupSpec {
        label: "Championship",
        players: ["GZero", "Rubric", "HL", "Validator"],
    },
];
...
fn print_header() {
    println!();
    println!("══════════════════════════════════════════════════════════════");
    println!("  Bomber Rubric Tournament (Plan 077)");
...
fn print_leaderboard(
    ...
    println!("```markdown");
    println!("## Bomber Rubric Tournament Results");
    println!();
