...
**Target:** `crates/katgpt-core/crates/katgpt-core/src/data_probe/geometry.rs` (extend) — inherits the existing `sink_aware_attn` feature gate (same as the sibling `effective_rank`)
