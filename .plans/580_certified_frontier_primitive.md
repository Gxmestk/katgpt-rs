...
- [-] **T4.3** ROUTED 2026-08-28 to [riir-ai Issue 774](../../riir-ai/.issues/774_certified_frontier_four_arm_gate.md) (commit `91f502ed2`) — riir-poc four-arm gate (riir-ai side, follow-up issue there): certified-frontier vs curiosity-only vs passive vs never-look at equal perception budget; 16 seeds; Prop-1 separation pre-registered as the PASS prediction.
