...
| `crates/katgpt-speculative/src/distill/trd.rs` + `distill/mod.rs` | 1142 | chain_fold-gated prefold_prefix depends on `crate::fold` | fold moves first (this plan T4.5 — TRD unblocks after) |
