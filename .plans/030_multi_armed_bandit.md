...
- [x] 1. Create `crates/katgpt-ruliology/src/bandit.rs` with `BanditStrategy` enum
...
|------|--------|-------------|
| `crates/katgpt-ruliology/src/bandit.rs` | Create | Core module: strategy, pruner, env, session |
