...
- [`evolve_motor_gated_field`](../crates/katgpt-dec/crates/katgpt-dec/src/motor_gated.rs) — the zero-alloc scratch-buffer pattern `stochastic_birth_death_step` mirrors
