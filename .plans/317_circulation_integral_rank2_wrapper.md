...
**Target:** `katgpt-rs/crates/katgpt-core/crates/katgpt-dec/src/stokes_calculus.rs` (+ bench + tests)
...
```
katgpt-rs/crates/katgpt-core/crates/katgpt-dec/src/stokes_calculus.rs
