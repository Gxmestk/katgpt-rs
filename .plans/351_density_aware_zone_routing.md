...
**Target:** `katgpt-rs/crates/katgpt-core/crates/katgpt-core/src/zone_density.rs` (new module, ~500 LOC + tests) + Cargo feature `zone_density_routing` (opt-in, NOT default until G5a+G5b+G5c pass).
