...
- [x] **T5**: Add MLS accumulator buffer to `ForwardContext` in `crates/katgpt-percepta/src/transformer.rs`
  ```rust
...
- Key files: `crates/katgpt-percepta/src/transformer.rs`, `crates/katgpt-core/src/types.rs`, `src/benchmark.rs`
