...
- [x] T4: Add `crates/katgpt-quant/src/octopus/types.rs` — `OctopusConfig`, `OctopusLayer`, `OctopusCodebook`
- [x] T5: Add `crates/katgpt-quant/src/octopus/encode.rs` — triplet encode with joint 3×3 rounding
- [x] T6: Add `crates/katgpt-quant/src/octopus/kv_cache.rs` — `OctopusKVCache` implementing `QuantizedKVCache` trait
- [x] T7: Add `crates/katgpt-quant/src/octopus/forward.rs` — score-path decode + attention scoring helpers
...
```rust
// crates/katgpt-quant/src/octopus/types.rs
