...
use crate::sdar::SdarGatedAbsorbCompress;
use crate::sdar_gate::{SDAR_BETA, sdar_gate};
...
///
/// Unlike [`BtComparison`](crate::bt_rank::BtComparison) which records
...
mod tests {
    ...
    use crate::sdar::SdarAbsorbConfig;
