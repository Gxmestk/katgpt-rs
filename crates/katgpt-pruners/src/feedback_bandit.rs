...
use crate::configurator_bandit::{ConfiguratorBandit, UCB1_C};
...
impl FeedbackBandit {
    ...
    fn select_6arm_ucb1(&mut self, context: ConfiguratorContext) -> PlanningDecision {
        ...
        for arm in 0..4 {
            let decision = crate::configurator_bandit::from_arm_index(arm);
        ...
        match best_arm {
            0..=3 => crate::configurator_bandit::from_arm_index(best_arm),
