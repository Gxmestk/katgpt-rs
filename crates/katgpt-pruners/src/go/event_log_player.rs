...
impl GoEventLog {
    ...
    where
        F: FnMut(S, &crate::event_log::Event<GoAction>) -> S,
    {
    ...
    /// Get an event by ID.
    pub fn get(&self, id: EventId) -> Option<&crate::event_log::Event<GoAction>> {
        self.log.get(id)
    }

    /// Iterate over all events.
    pub fn iter(&self) -> impl Iterator<Item = &crate::event_log::Event<GoAction>> {
        self.log.iter()
    }
