...
impl<P: ScreeningPruner> SdpgBanditPruner<P> {
    ...
    // SdpgBanditPruner::from_replay + load_teacher_q_from_replay moved back to
    // the main crate's bomber module (src/pruners/bomber/sdpg_helpers.rs).
    // They depend on bomber's ReplaySample type which stayed in the main crate
    // after Plan 005 extraction.
}
