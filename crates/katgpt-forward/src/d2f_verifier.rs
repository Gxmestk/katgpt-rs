...
//! The historical "Root-resident by design (Issue 033 §C)" comment was
//! obsolete — all three blockers (root-only `crate::dllm`,
//! `crate::transformer::forward`, `crate::speculative::verifier`) now resolve
//! to leaf crates: `crate::d2f_context`, `crate::forward`, and
