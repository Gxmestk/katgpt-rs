...
| `crates/katgpt-core/crates/katgpt-core/src/product_key_memory/episodic.rs` | `PkmEpisodicStore` (Phase 5, gated `product_key_memory_episodic`) — δ-rule write gate (F1 fusion: PKM × δ-Mem) |
