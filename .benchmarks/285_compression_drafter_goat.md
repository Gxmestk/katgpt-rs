...
|------|------------------|
| `katgpt-rs/crates/katgpt-core/crates/katgpt-core/src/compression_drafter.rs` | + `MatchScorer` trait, `Lz4MatchScorer`, `MatchLengthScorer` (inverted index), `beam_search()`, `corpus_alphabet()` + 9 new unit tests (15 total) |
