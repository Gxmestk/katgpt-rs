...
| File | Change |
|------|--------|
| `katgpt-rs/crates/katgpt-core/crates/katgpt-dec/src/stokes_calculus.rs` | Extracted `boundary_flux_mass_only` (mass without hodge_decompose) from `boundary_flux_mass` |
